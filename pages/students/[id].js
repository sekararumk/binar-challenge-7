                ...
                <>
                    ...
                    { students.attributes.photo.data !== null &&
                        ...
                        <div className="card-body">
                          ...
                          <h5 className={styles.text_style}>First Name : {students.attributes.firstname}</h5>
                          <h5 className={styles.text_style}>Last Name : {students.attributes.lastname}</h5>
                          <h5 className={styles.text_style}>Location : {students.sattributes.location}</h5>
                        </div>
                      </div>
                </>
            )}
